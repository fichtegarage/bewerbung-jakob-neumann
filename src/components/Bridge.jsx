export default function Bridge() {
  return (
    <section id="hintergrund" className="section reveal">
      <span className="eyebrow">Hintergrund</span>
      <p>
        Als Fachexperte für Multimedia arbeite ich seit mehreren Jahren mit
        Video und Audio – von der Produktion eines eigenen Podcasts bis zur
        eigenständigen Arbeit als Videograf und Editor. Parallel dazu
        übersetze ich in komplexen Infrastrukturprojekten zwischen
        Kommunalpolitik, Bürgerinitiativen und Projektorganisation. Beides
        braucht dieselbe Grundfähigkeit: komplizierte Inhalte so
        aufzubereiten, dass sie ankommen – und die Menschen dahinter für eine
        Sache zu gewinnen.
      </p>
      <p>
      ...
      <p>
        ...
        Hintergrund – beizubringen, digitale Lösungen selbst zu entwickeln.
        Der Anstoß war immer derselbe: ein reales Problem, für das es keine
